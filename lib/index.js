...
const contentAll = contentFile(fileAbsolute); // --------------------------- Turn markdown into a html ---------------------

const html = marked(contentFile(fileAbsolute));
console.log(html); // -----------------------------Extrayendo links con regular expresions ---------
...
const allFiles = []; // eslint-disable-next-line no-shadow
...
console.log(walk(dirAbsolute)); // ----------------------------Validate ----------------------